...
```bash
bash <(curl -fsSL https://github.com/lokidv/sing-box-reality-hysteria2/raw/main/beta.sh)
```

### reality hysteria2二合一脚本

```bash
bash <(curl -fsSL https://github.com/lokidv/sing-box-reality-hysteria2/raw/main/install.sh)
```
